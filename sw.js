const CACHE_NAME = 'es90-sales-app-v271';
    ...
    event.respondWith(
      fetch(event.request, { cache: 'no-store' })
        ...
        .catch(() => {
          ...
          return caches.match(event.request).then(hit => hit || caches.match('./app.html'));
        })
    );
    return;
  }
